                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-5 py-3">
                        <div class="flex gap-1.5 justify-end">
                            <a href="{{ route('admin.kelas.edit', $k) }}" title="Edit Kelas" class="inline-flex items-center justify-center w-8 h-8 rounded-lg bg-primary-50 text-primary-600 hover:bg-primary-100 hover:text-primary-700 transition-all duration-200">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg>
                            </a>
                            <form action="{{ route('admin.kelas.destroy', $k) }}" method="POST" class="inline" onsubmit="return confirm('Hapus kelas ini?')">@csrf @method('DELETE')
                                <button type="submit" title="Hapus Kelas" class="inline-flex items-center justify-center w-8 h-8 rounded-lg bg-danger-50 text-danger-500 hover:bg-danger-100 hover:text-danger-600 transition-all duration-200">
